...
export type UserFragment = { __typename?: 'User', id: string, name?: string | null, first_name: string, middle_name?: string | null, last_name: string, email: string, phone?: string | null, password: string, is_admin: boolean, is_active: boolean, created_at: any, updated_at: any, deleted_at?: any | null, roles: Array<{ __typename?: 'Role', id: string, name: string } | null>, messages?: Array<(
    { __typename?: 'Message' }
    & { ' $fragmentRefs'?: { 'MessageFragment': MessageFragment } }
  ) | null> | null, resident?: { __typename?: 'Resident', id: string } | null } & { ' $fragmentName'?: 'UserFragment' };

export type HouseholdFragment = { __typename?: 'Household', id: string, household_no: string, address?: string | null, created_at: any, updated_at: any } & { ' $fragmentName'?: 'HouseholdFragment' };
