...
export type DtrReport = {
  __typename?: 'DTRReport';
  attendances: Array<Attendance>;
  extra_hours?: Maybe<Scalars['Float']['output']>;
  normal_hours: Scalars['Float']['output'];
  salary: Scalars['Float']['output'];
  total_hours: Scalars['Float']['output'];
  total_working_days: Scalars['Int']['output'];
  user: User;
};

export type DailyTimeRecordPaginator = {
  __typename?: 'DailyTimeRecordPaginator';
  data: Array<DtrReport>;
  paginatorInfo: PaginatorInfo;
};
...
export type Query = {
  ...
  dailyTimeRecord?: Maybe<DailyTimeRecordPaginator>;
...
export type QueryAttendancePaginateArgs = {
  ...
  where?: InputMaybe<QueryAttendancePaginateWhereWhereConditions>;
};
...
export type QueryDailyTimeRecordArgs = {
  end: Scalars['DateTime']['input'];
  filter?: InputMaybe<Array<InputMaybe<FilterDtr>>>;
  first: Scalars['Int']['input'];
  page?: InputMaybe<Scalars['Int']['input']>;
...
/** Allowed column names for Query.attendancePaginate.where. */
export enum QueryAttendancePaginateWhereColumn {
  CreatedAt = 'CREATED_AT',
  Date = 'DATE'
}

/** Dynamic WHERE conditions for the `where` argument of the query `attendancePaginate`. */
export type QueryAttendancePaginateWhereWhereConditions = {
  /** A set of conditions that requires all conditions to match. */
  AND?: InputMaybe<Array<QueryAttendancePaginateWhereWhereConditions>>;
  /** Check whether a relation exists. Extra conditions or a minimum amount can be applied. */
  HAS?: InputMaybe<QueryAttendancePaginateWhereWhereConditionsRelation>;
  /** A set of conditions that requires at least one condition to match. */
  OR?: InputMaybe<Array<QueryAttendancePaginateWhereWhereConditions>>;
  /** The column that is used for the condition. */
  column?: InputMaybe<QueryAttendancePaginateWhereColumn>;
...
/** Dynamic HAS conditions for WHERE conditions for the `where` argument of the query `attendancePaginate`. */
export type QueryAttendancePaginateWhereWhereConditionsRelation = {
  /** The amount to test. */
  amount?: InputMaybe<Scalars['Int']['input']>;
  /** Additional condition logic. */
  condition?: InputMaybe<QueryAttendancePaginateWhereWhereConditions>;
...
export type AttendancePaginateQueryVariables = Exact<{
  ...
  whereConditions?: InputMaybe<QueryAttendancePaginateWhereWhereConditions>;
}>;
...
export type AttendanceByDateQueryVariables = Exact<{
  user_id: Scalars['ID']['input'];
  date: Scalars['String']['input'];
}>;


export type AttendanceByDateQuery = { __typename?: 'Query', attendanceByDate?: { __typename?: 'Attendance', id: string, user: { __typename?: 'User', name?: string | null } } | null };

export type DailyTimeRecordQueryVariables = Exact<{
  first: Scalars['Int']['input'];
  page?: InputMaybe<Scalars['Int']['input']>;
  filter?: InputMaybe<Array<InputMaybe<FilterDtr>> | InputMaybe<FilterDtr>>;
  start: Scalars['DateTime']['input'];
  end: Scalars['DateTime']['input'];
}>;


export type DailyTimeRecordQuery = { __typename?: 'Query', dailyTimeRecord?: { __typename?: 'DailyTimeRecordPaginator', data: Array<{ __typename?: 'DTRReport', total_hours: number, normal_hours: number, extra_hours?: number | null, salary: number, total_working_days: number, user: { __typename?: 'User', id: string, name?: string | null, hourly_rate?: number | null }, attendances: Array<{ __typename?: 'Attendance', date?: any | null, am_time_in?: any | null, am_time_out?: any | null, pm_time_in?: any | null, pm_time_out?: any | null, extra_time_in_1?: any | null, extra_time_out_1?: any | null, extra_time_in_2?: any | null, extra_time_out_2?: any | null }> }>, paginatorInfo: { __typename?: 'PaginatorInfo', currentPage: number, lastPage: number, perPage: number, total: number } } | null };
...
export type UserFragment = { __typename?: 'User', id: string, avatar_url?: string | null, name?: string | null, first_name: string, middle_name?: string | null, last_name: string, email: string, phone?: string | null, password: string, is_admin: boolean, face_descriptors?: any | null, is_active?: boolean | null, hourly_rate?: number | null, created_at: any, updated_at: any, deleted_at?: any | null, roles: Array<{ __typename?: 'Role', id: string, name: string } | null>, resident?: { __typename?: 'Resident', id: string } | null } & { ' $fragmentName'?: 'UserFragment' };
...
export type UpsertUserAvatarMutationVariables = Exact<{
  id: Scalars['ID']['input'];
  avatar: Scalars['Upload']['input'];
}>;


export type UpsertUserAvatarMutation = { __typename?: 'Mutation', upsertUserAvatar?: { __typename?: 'User', id: string, avatar_url?: string | null } | null };
...
export type DeleteUserAvatarMutation = { __typename?: 'Mutation', deleteUserAvatar?: { __typename?: 'User', id: string, avatar_url?: string | null } | null };
...
export const AttendanceByDateDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"attendanceByDate"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"user_id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"date"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"attendanceByDate"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"user_id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"user_id"}}},{"kind":"Argument","name":{"kind":"Name","value":"date"},"value":{"kind":"Variable","name":{"kind":"Name","value":"date"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}}]}}]} as unknown as DocumentNode<AttendanceByDateQuery, AttendanceByDateQueryVariables>;
export const DailyTimeRecordDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"dailyTimeRecord"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"first"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"page"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"filter"}},"type":{"kind":"ListType","type":{"kind":"NamedType","name":{"kind":"Name","value":"FilterDtr"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"start"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"DateTime"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"end"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"DateTime"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"dailyTimeRecord"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"filter"},"value":{"kind":"Variable","name":{"kind":"Name","value":"filter"}}},{"kind":"Argument","name":{"kind":"Name","value":"start"},"value":{"kind":"Variable","name":{"kind":"Name","value":"start"}}},{"kind":"Argument","name":{"kind":"Name","value":"end"},"value":{"kind":"Variable","name":{"kind":"Name","value":"end"}}},{"kind":"Argument","name":{"kind":"Name","value":"first"},"value":{"kind":"Variable","name":{"kind":"Name","value":"first"}}},{"kind":"Argument","name":{"kind":"Name","value":"page"},"value":{"kind":"Variable","name":{"kind":"Name","value":"page"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"data"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"hourly_rate"}}]}},{"kind":"Field","name":{"kind":"Name","value":"total_hours"}},{"kind":"Field","name":{"kind":"Name","value":"normal_hours"}},{"kind":"Field","name":{"kind":"Name","value":"extra_hours"}},{"kind":"Field","name":{"kind":"Name","value":"salary"}},{"kind":"Field","name":{"kind":"Name","value":"total_working_days"}},{"kind":"Field","name":{"kind":"Name","value":"attendances"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"date"}},{"kind":"Field","name":{"kind":"Name","value":"am_time_in"}},{"kind":"Field","name":{"kind":"Name","value":"am_time_out"}},{"kind":"Field","name":{"kind":"Name","value":"pm_time_in"}},{"kind":"Field","name":{"kind":"Name","value":"pm_time_out"}},{"kind":"Field","name":{"kind":"Name","value":"extra_time_in_1"}},{"kind":"Field","name":{"kind":"Name","value":"extra_time_out_1"}},{"kind":"Field","name":{"kind":"Name","value":"extra_time_in_2"}},{"kind":"Field","name":{"kind":"Name","value":"extra_time_out_2"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"paginatorInfo"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"currentPage"}},{"kind":"Field","name":{"kind":"Name","value":"lastPage"}},{"kind":"Field","name":{"kind":"Name","value":"perPage"}},{"kind":"Field","name":{"kind":"Name","value":"total"}}]}}]}}]}}]} as unknown as DocumentNode<DailyTimeRecordQuery, DailyTimeRecordQueryVariables>;
...
export const UpsertUserAvatarDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"upsertUserAvatar"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"avatar"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Upload"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"upsertUserAvatar"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}},{"kind":"Argument","name":{"kind":"Name","value":"avatar"},"value":{"kind":"Variable","name":{"kind":"Name","value":"avatar"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"avatar_url"}}]}}]}}]} as unknown as DocumentNode<UpsertUserAvatarMutation, UpsertUserAvatarMutationVariables>;
export const DeleteUserAvatarDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"deleteUserAvatar"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deleteUserAvatar"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"avatar_url"}}]}}]}}]} as unknown as DocumentNode<DeleteUserAvatarMutation, DeleteUserAvatarMutationVariables>;
