        ...
        >
            ...
            <div class="max-w-2xl mx-auto px-6 text-center z-10">
                ...
                >
                    ...
                    >
                        Access city government services online.
                    </span>
                    Apply for permits, pay taxes, track projects, and stay
                    updated with citywide announcements and services.
                </p>
                ...
                <div class="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-6">
                    ...
                    <div
                        class="p-4 rounded-lg bg-stone-100 dark:bg-stone-800/50 border border-stone-200 dark:border-stone-700"
                    >
                        <div
                            class="w-8 h-8 bg-green-100 dark:bg-green-900/50 rounded-lg flex items-center justify-center mb-3 mx-auto"
                        >
                            <UIcon
                        ...
                        <p class="text-xs text-slate-600 dark:text-gray-400">
                            Apply for business permits, tax clearances, and
                    ...
                    >
                        ...
                        <p class="text-xs text-slate-600 dark:text-gray-400">
                            Stay updated with citywide news, projects, and
                            community events
                        </p>
                    </div>
                    ...
                    >
                        ...
                        <p class="text-xs text-slate-600 dark:text-gray-400">
                            Report city concerns and request assistance from
                            departments
                        </p>
                    </div>
                </div>
