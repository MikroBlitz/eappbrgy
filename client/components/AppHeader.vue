            ...
            <div class="flex items-center justify-between max-w-full">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <UDropdown
                        ...
                        class="flex ml-2 items-center hover:bg-slate-100/70 dark:hover:bg-slate-800/70 rounded-lg p-1 transition-colors duration-200"
                    >
                        <div class="flex items-center gap-2 cursor-pointer">
                            ...
                            >
                                <span
                                    ...
                                    :title="auth.user?.first_name || 'No Name'"
                                >
                                    Hi,
